  ...
  translatorFactory(){
    var self = {
      ...
      createTranslator : function (translations, defaults) {
        //console.log('DEBUG: i18n translations ' + Object.prototype.toString(translations));
        defaults = defaults || {};
        var _this = this;
        return function (key) {
          var value = self.getKey(translations, key, null);
          //console.log('DEBUG: createTranslator key ' + key);
          if (value === null) {
    ...
    //console.log('DEBUG: i18n translator factory ' + self.getKey(''));
    return self;
