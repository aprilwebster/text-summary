...
module.exports = {
  ...
  'needs': {
    'Challenge': [
      'prestige', 'competition', 'glory'
    ],
    'Closeness': [
      'belongingness', 'nostalgia', 'intimacy'
    ],
    'Curiosity': [
      'discovery', 'mastery', 'gaining knowledge'
    ],
    'Excitement': [
      'revelry', 'anticipation', 'exhiliration'
    ],
    'Harmony': [
      'well-being', 'courtesy', 'politeness'
    ],
    'Ideal': [
      'sophistication', 'spirituality', 'superiority', 'fulfillment'
    ],
    'Liberty': [
      'modernity', 'expanding possibility', 'escape', 'spontaneity', 'novelty'
    ],
    'Love': [
      'connectedness', 'affinity'
    ],
    'Practicality': [
      'efficiency', 'practicality', 'high value', 'convenience'
    ],
    'Self-expression': [
      'self-expression', 'personal empowerment', 'personal strength'
    ],
    'Stability': [
      'stability', 'authenticity', 'trustworthiness'
    ],
